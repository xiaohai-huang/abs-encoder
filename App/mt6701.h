 ...
 *
 * Every call is indexed by encoder (0..MT6701_ENC_COUNT-1).  On this
 * board encoders 0/1 share SPI1 (CSN1/CSN2) and encoders 2/3 share SPI2
 * (CSN3/CSN4); the index maps to bus and CS in the HAL implementations.
 ...
 * @param enc encoder index 0..MT6701_ENC_COUNT-1
